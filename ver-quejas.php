...
function verQuejaUsuario($user, $con)
{
    ...
    $query = mysqli_query($con, "SELECT * FROM quejas where usuario_id = $usuario_id order by queja_id desc");
?>
...
{
    $query = mysqli_query($con, "SELECT * FROM quejas WHERE estado_id = 1 ORDER BY queja_id DESC");
?>
    <div class="h1 text-center text-primary">
    ...
    <div class="row justify-content-around">
        ...
        <?php $res = mysqli_query($con, "SELECT * from quejas WHERE estado_id = 2 OR estado_id = 3 ORDER BY queja_id DESC"); ?>
        <div class="col-5">
            <div class="h4 text-center">
                Quejas Resueltas:
            </div>
