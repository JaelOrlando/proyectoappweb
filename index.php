...
$query = mysqli_query($con, "SELECT * FROM quejas q INNER JOIN usuarios u on q.usuario_id = u.usuario_id INNER JOIN imagenes i on q.imagen_id = i.imagen_id INNER JOIN queja qu on q.q_id = qu.q_id WHERE qu.eliminado = 0 and q.filtro_id = 1 and u.tipo_usuario_id = 2 ORDER BY queja_id DESC");
